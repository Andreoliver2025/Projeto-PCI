...
export default function ConviteCandidatoPage() {
  ...
  const handleComecarTestes = async () => {
    ...
    try {
      // Redirecionar para página de testes passando o token do convite
      router.push(`/testes/disc?convite=${token}`)
    } catch (err) {
  ...
  if (error) {
    ...
    const isInvalid = error.code === 'INVALID'
        ...
        <div className="max-w-md w-full">
          <div className="card">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-textSecondary">
                Você foi convidado(a) para participar de um processo de seleção
              </p>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-900">
                <strong>O que você fará:</strong> Você participará de testes comportamentais DISC e MBTI que ajudam a avaliar seu perfil profissional. O processo leva aproximadamente 15-20 minutos.
              </p>
            </div>
