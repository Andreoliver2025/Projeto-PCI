...
export default function TesteDISC() {
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="max-w-2xl w-full">
          <div className="card text-center">
            ...
            <div className="mb-8">
              <p className="text-lg text-gray-600 mb-2">Seu perfil principal:</p>
      ...
      <header className="bg-white border-b border-secondary-200" role="banner">
        <div className="container-narrow py-3">
          ...
          <p className="text-caption text-textSecondary mt-1 text-center">
            Vamos entender como você funciona. Leva menos de 7 minutos.
          </p>
        </div>
      </header>

      {/* Question - tom calmo e centrado no usuário */}
